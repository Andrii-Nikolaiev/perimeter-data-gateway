...
namespace Perimeter.Gateway.AcceptanceTests.T02;

[Collection(AcceptanceCollection.Name)]
public sealed class ResourceLevelDenyTests
{
    private readonly AcceptanceEnvironment _environment;

    public ResourceLevelDenyTests(
    ...
    [Fact]
    public async Task T02_Resource_level_deny_returns_403_without_reading_corporate_data()
    {
        var ct =
